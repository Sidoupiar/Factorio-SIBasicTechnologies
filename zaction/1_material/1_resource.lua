...
.NewItem( "发现-清火中和" )
.AddCondition_Has( SIFinder.Item( "桶装-清水" ) , 100 )
.AddCondition_Has( SIFinder.Item( "桶装-火苗" ) , 100 )
.AddResult_AddRecipe( SIFinder.Recipe( "清火中和" ) )
.AddResult_RemoveItem( SIFinder.Item( "桶装-清水" ) , 100 )
.AddResult_RemoveItem( SIFinder.Item( "桶装-火苗" ) , 100 )
.AddResult_MessageForce( { "SIBT.new-recipe" } , true )
.AddResult_MessagePlayer( { "SIBT.lost-something" } )

.NewItem( "发现-清水和火苗的应用" )
.AddCondition_Has( SIFinder.Item( "桶装-清水" ) , 300 )
.AddCondition_Has( SIFinder.Item( "桶装-火苗" ) , 300 )
.AddCondition_Has( SIFinder.Item( "water-barrel" ) , 300 )
.AddCondition_Has( SIFinder.Item( "矿石壳屑" ) , 100 )
.AddResult_AddRecipe( SIFinder.Recipe( "清水稀释" ) )
.AddResult_AddRecipe( SIFinder.Recipe( "爆热蒸发" ) )
.AddResult_AddRecipe( SIFinder.Recipe( "极寒凝结" ) )
.AddResult_RemoveItem( SIFinder.Item( "桶装-清水" ) , 300 )
.AddResult_RemoveItem( SIFinder.Item( "桶装-火苗" ) , 300 )
.AddResult_RemoveItem( SIFinder.Item( "water-barrel" ) , 300 )
.AddResult_MessageForce( { "SIBT.new-recipe" } , true )
.AddResult_MessagePlayer( { "SIBT.lost-something" } )

.NewItem( "发现-冰澄物质萃取" )
.AddCondition_Build( SIFinder.Entity( "萃取炉" , SITypes.item.furnace ) , 5 )
.AddCondition_Use( SIFinder.Item( "矿山石核-多孔" , SITypes.item.capsule ) , 25 )
.AddResult_AddRecipe( SIFinder.Recipe( "冰澄物质萃取" ) )
.AddResult_MessageForce( { "SIBT.new-recipe" } , true )

.NewItem( "发现-躁动物质萃取" )
.AddCondition_Build( SIFinder.Entity( "萃取炉" , SITypes.item.furnace ) , 8 )
.AddCondition_Use( SIFinder.Item( "矿山石核-多孔" , SITypes.item.capsule ) , 25 )
.AddResult_AddRecipe( SIFinder.Recipe( "躁动物质萃取" ) )
.AddResult_MessageForce( { "SIBT.new-recipe" } , true )

.NewItem( "发现-永恒物质萃取" )
.AddCondition_Build( SIFinder.Entity( "萃取炉" , SITypes.item.furnace ) , 12 )
.AddCondition_Use( SIFinder.Item( "矿山石核-多孔" , SITypes.item.capsule ) , 25 )
.AddResult_AddRecipe( SIFinder.Recipe( "永恒物质萃取" ) )
.AddResult_MessageForce( { "SIBT.new-recipe" } , true )

.NewItem( "发现-静谧物质萃取" )
.AddCondition_Build( SIFinder.Entity( "萃取炉" , SITypes.item.furnace ) , 15 )
.AddCondition_Use( SIFinder.Item( "矿山石核-多孔" , SITypes.item.capsule ) , 25 )
.AddResult_AddRecipe( SIFinder.Recipe( "静谧物质萃取" ) )
.AddResult_MessageForce( { "SIBT.new-recipe" } , true )
.Finish()
