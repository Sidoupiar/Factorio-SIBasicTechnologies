...
.AddCosts( SIPackers.SingleFluidIngredient( "清水" , 100 ) )
.AddCosts( SIPackers.SingleFluidIngredient( "火苗" , 100 ) )
...
.SetRecipeTypes( SIBT.recipeType.withFluid )
.AddCosts( SIPackers.SingleFluidIngredient( "清水" , 100 ) )
.AddCosts( SIPackers.SingleFluidIngredient( "火苗" , 25 ) )
.AddCosts( SIPackers.SingleFluidIngredient( "water" , 1 ) )
...
.SetEnergy( 4 )
.SetRecipeTypes( SIBT.recipeType.withFluid )
.AddCosts( SIPackers.SingleFluidIngredient( "火苗" , 50 ) )
.AddCosts( SIPackers.SingleFluidIngredient( "water" , 85 ) )
...
.SetEnergy( 5 )
.SetRecipeTypes( SIBT.recipeType.withFluid )
.AddCosts( SIPackers.SingleFluidIngredient( "清水" , 50 ) )
.AddCosts( SIPackers.SingleFluidIngredient( "steam" , 85 , 160 , 170 ) )
...
.SetRecipeTypes( SIBT.recipeType["萃取炉"] )
.AddCosts( "矿山石核-多孔" , 3 )
.AddCosts( SIPackers.SingleFluidIngredient( "呼唤" , 100 ) )
.AddResults( SIPackers.SingleFluidProduct( "water" , 75 , nil , nil , nil , 75 ) )
...
.SetRecipeTypes( SIBT.recipeType["萃取炉"] )
.AddCosts( "矿山石核-多孔" , 3 )
.AddCosts( SIPackers.SingleFluidIngredient( "安宁" , 100 ) )
.AddResults( SIPackers.SingleFluidProduct( "water" , 75 , nil , nil , nil , 75 ) )
...
.E.SetItemStackSize( 5 )
.SetSize( SIUtils.PointsBorder( 4 , 4 ) )
.SetEnergy( nil , SIPackers.ElectricEnergySource( SITypes.electricUsagePriority.tertiary , "1MJ" , nil , "1MW" , "1MW" ) )
...
.E.SetItemStackSize( 5 )
.SetSize( 2 , 2 )
.SetEnergy( nil , SIPackers.ElectricEnergySource( SITypes.electricUsagePriority.tertiary , "500KJ" , nil , "500KW" , "500KW" ) )
.AddPluginTypes( SIBT.equipmentType.armor )
.FillImage()